...
# EMAIL: 
# 
# COMMENT:  This script check the following:
#           1. Ping Status
#           2. check Netlogon service
#           3. Check NTDS Service
#           4. Check DNS Service
#           5. Perform a Replication Test
#           6. Check Services on Domain Controllers
#           7. Check FSMO Roles
#
#           All of these results will be emailed to the specified email address(s)
#
#
# VERSION HISTORY
# 1.0 2018.04.27 Initial Version.
# 1.1 2018.05.09 Changed some output colors to make the email looks better
# 1.2
#
# TO ADD
# -Add a Function to ...
...
$reportpath = "c:\prod_scripts\output\ADReport.htm" 

if((test-path $reportpath) -like $false)
{
new-item $reportpath -type file
}
$smtphost = "mailserver.domain.com" 
...
$body = Get-Content "c:\prod_scripts\output\ADreport.htm" 
